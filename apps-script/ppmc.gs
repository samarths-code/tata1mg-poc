 ...
 *      A: Date | B: Meeting ID | C: Doctor Link | D: Patient Link | E: Status | F: Recording URL
 * ──────────────────────────────────────────────────────────────────────────────
 *
...
function generateLinks() {
  ...
  var response;
  try {
    response = UrlFetchApp.fetch(backendUrl + "/api/v1/ppmc/sessions/bulk", {
      method: "post",
...
// ── 2. doPost — receives status/recording-URL updates from Flask backend ──────
