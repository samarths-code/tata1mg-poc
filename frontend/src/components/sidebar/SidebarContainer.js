...
import DocumentSubmitPanel from "../DocumentSubmitPanel";
    ...
    >
      ...
      >
        <>
          ...
          ) : sideBarMode === sideBarModes.IMAGE_PANEL ? (
            <ImagePreviewPanel panelHeight={panelHeight} />
          ) : sideBarMode === sideBarModes.DOCUMENT_PANEL ? (
            <DocumentSubmitPanel panelHeight={panelHeight} />
          ) : null}
        </>
      </div>
    </div>
